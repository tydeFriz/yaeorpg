...
from models.spells.action_components.component_archer_poison_arrow import ComponentArcherPoisonArrow01


class ArcherPoisonArrow(Action):
	...
	def _compose(self) -> list[ActionComponent]:
		return [
			ComponentArcherPoisonArrow01(self)
		]
