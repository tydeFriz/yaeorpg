...
from models.spells.action_components.component_guardian_health_boost import ComponentGuardianHealthBoost01


class GuardianHealthBoost(Action):
	...
	def _compose(self) -> list[ActionComponent]:
		return [
			ComponentGuardianHealthBoost01(self)
		]
