...
from models.spells.action_components.component_archer_slowing_arrow import ComponentArcherSlowingArrow01


class ArcherSlowingArrow(Action):
	...
	def _compose(self) -> list[ActionComponent]:
		return [
			ComponentArcherSlowingArrow01(self)
		]
